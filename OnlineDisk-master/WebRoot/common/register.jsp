...
<body>
	<div class="login">
			...
			<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="<%=basePath%>RegisterServlet" method="post">				
		...
		<div class="footer">
			<div style="text-align:center;margin:50px 0; font:normal 14px/24px 'MicroSoft YaHei';">
				<p>作者：成都信息工程大学    网络空间安全学院    网络工程（实验）151   黄源 2015121081 </p>
			</div>
		</div>
	</div>
</body>
